class Houston.TestingReport.TestingTicketView extends Backbone.View
  tagName: 'tr'
  className: 'ticket'
  ...
  initialize: (options)->
    ...
    @renderTicket = HandlebarsTemplates['houston/testing_report/testing_report/ticket']
    @renderTicketDescription = HandlebarsTemplates['houston/testing_report/testing_report/description']
    @renderTesterVerdict = HandlebarsTemplates['houston/testing_report/testing_report/verdict']
    @renderNewTestingNote = HandlebarsTemplates['houston/testing_report/testing_notes/new']
  ...
  renderTestingNotes: ->
    ...
    @ticket.activityStream().each (item)=>
      if item.constructor == Houston.TestingReport.TestingNote
  ...
  viewForTestingNote: (testingNote)->
    view = new Houston.TestingReport.TestingNoteView(model: testingNote)
  ...
  viewForCommit: (commit)->
    new Houston.TestingReport.CommitView(model: commit)
  ...
  createTestingNote: (e)->
    ...
    testingNote = new Houston.TestingReport.TestingNote
      ticketId: @ticket.get('id')
